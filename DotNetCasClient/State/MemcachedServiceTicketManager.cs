...
{
    /// <summary>
    /// An IServiceTicketManager implementation in .NET 4.5 that leverages
    /// Memcached for ticket storage in a clustered environment.
    /// 
    /// Based on the original CacheServiceTicketManager to address the limitations thereof
    ...
    public sealed class MemcachedServiceTicketManager : IServiceTicketManager
    {
        ...
        public CasAuthenticationTicket GetTicket(string serviceTicket)
        {
            ...
            //var doc = bucket.GetDocument<JObject>(key).Content;
            //return DeserializeCasAuthenticationTicket(doc);

            return _cache.Get<CasAuthenticationTicket>(key);
        }
        ...
        public void InsertTicket(CasAuthenticationTicket casAuthenticationTicket, DateTime expiration)
        {
            ...
            _cache.Store(StoreMode.Set, key, casAuthenticationTicket, expiration);
        }
        ...
        public bool ContainsTicket(string serviceTicket)
        {
            ...
            return _cache.TryGet(key, out ticket);
        }
        ...
        private static string GetTicketKey(string serviceTicket)
        {
            ...
            return CacheTicketKeyPrefix + serviceTicket;
        }
    }
}
